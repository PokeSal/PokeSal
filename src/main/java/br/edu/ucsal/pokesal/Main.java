...
public class Main {
  ...
  /**
   * Ponto de entrada do programa que gerencia o menu e o fluxo do combate.
   *
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        "2º a agir: " + batalha.getSegundoAtacante().getNome() + " [" + treinadorSegundo + "]");
    ...
    while (pokeSal1.isVivo() && pokeSal2.isVivo()) {
      ...
      System.out.println("\n>>> TURNO DE " + nomeTreinadorDaVez.toUpperCase() + " ("
          + atacante.getNome() + ") <<<");
      ...
      try {
        ...
        switch (acaoEscolhida) {
          case 1:
            ...
            System.out.println("\n[AÇÃO] " + atacante.getNome() + " [" + nomeTreinadorDaVez
                + "] atacou " + defensor.getNome() + " [" + nomeTreinadorAdversario + "] causando "
                + dano + " de dano!");
    ...
    if (vencedorBatalha != null) {
      System.out.println(" O GRANDE VENCEDOR É O TREINADOR: " + treinadorVencedor.toUpperCase()
          + " COM SEU " + vencedorBatalha.getNome().toUpperCase() + "!");
    } else {
